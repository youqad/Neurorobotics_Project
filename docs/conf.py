...
html_logo = '_static/logo_project_64px.svg'
...
html_theme_options = {
    ...
    'header_links' : [
        ...
        ("Slides", " http://younesse.net/assets/Slides/Inferring-space-from-sensorimotor-dependencies/Final_Presentation.html", True, 'slideshow')
